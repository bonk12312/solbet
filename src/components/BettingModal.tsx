...
export const BettingModal = ({ market, isOpen, onClose }: BettingModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-gray-900 border border-purple-800/40 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl shadow-purple-900/30 transform transition-all duration-300">
        <div className="sticky top-0 bg-gray-900 border-b border-purple-900/30 p-6 flex items-start justify-between">
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-purple-500 to-purple-600 shadow-lg"
          ...
          <div>
            ...
            <input
              ...
              step="0.1"
              min="0"
              className="w-full bg-gray-800 text-white text-lg px-4 py-3 rounded-lg border border-purple-900/30 focus:border-purple-700/50 focus:outline-none focus:shadow-lg focus:shadow-purple-900/10"
            />
          </div>
          ...
          {betAmount > 0 && (
            <div className="bg-gray-800/50 rounded-lg p-5 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`font-bold ${potentialProfit > 0 ? 'text-purple-400' : 'text-gray-400'}`}>
          ...
          <button
            ...
            className={`w-full py-3.5 rounded-lg font-bold text-lg transition-all shadow-lg ${
              side === 'yes'
                ? 'bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white shadow-purple-900/30'
