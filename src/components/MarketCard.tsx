  ...
  return (
    <>
      <div
        ...
        className="bg-gray-900 border border-purple-900/30 rounded-lg p-5 hover:border-purple-700/50 hover:shadow-lg hover:shadow-purple-900/20 transition-all duration-300 cursor-pointer group transform hover:-translate-y-0.5"
      >
        <div className="flex items-start gap-4">
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex items-center gap-2">
                <div className="bg-gradient-to-br from-purple-800/40 to-purple-900/40 p-2 rounded-lg shrink-0 border border-purple-800/30">
                  {getCryptoIcon(market.icon)}
                </div>
                <h3 className="text-white font-medium text-[13px] leading-tight group-hover:text-purple-200 transition-colors">
                  {market.question}
                </h3>
              </div>
              {getOutcomeBadge()}
            ...
            <div className="flex items-center gap-4 mb-3">
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-purple-400 font-medium text-xs">{yesPercent}%</span>
                </div>
                <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-1.5 text-gray-500 text-xs">
                ...
                <span className="text-purple-400">↑{formatVolume(market.yes_volume)}</span>
              </div>
            ...
            <div className="mt-2 h-1 bg-gray-800 rounded-full overflow-hidden">
              <div className="flex h-full">
                <div
                  className="bg-gradient-to-r from-purple-500 to-purple-600 transition-all shadow-lg"
